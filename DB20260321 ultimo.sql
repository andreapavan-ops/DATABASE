...
--
-- Host: localhost    Database: andrea_pavan
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='prima tabella woocommerce - AREA GEOGRAFICA';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nazione` VALUES (1,'ITALIA'),(2,'FRANCIA'),(3,'GERMANIA'),(4,'SPAGNA'),(5,'STATI UNITI');
...
CREATE TABLE `provincia` (
  ...
  KEY `id_nazione_fk_idx` (`id_nazione_fk`),
  CONSTRAINT `fk_provincia_nazione` FOREIGN KEY (`id_nazione_fk`) REFERENCES `nazione` (`id_nazione`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='seconda tabella woocommerce - AREA GEOGRAFICA';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `provincia` VALUES (1,'Venezia','VE',1),(2,'Milano','MI',1),(3,'Roma','RM',1),(4,'Parigi','PR',2),(5,'Lione','LY',2),(6,'Madrid','MD',4);
...
-- Dump completed on 2026-03-20 17:46:26
